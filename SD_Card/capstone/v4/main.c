...
int main() {
    // Open UIO device for AXI4-Lite access
    ...
    // Memory-map the AXI register region
    ...
    // Launch UDP receive, steering, and drive threads
    ...
    // Pass both regs and shared via args array
