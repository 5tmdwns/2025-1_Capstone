<p align="center">
  ...
  <img width="85%" alt="result" src="https://github.com/user-attachments/assets/a1b39a67-58fd-457b-8828-470da482a7d8" />
</p>
...
<p align="center" style="margin: 20px 0;">
  <img width="85%" alt="install_config.txt 사진" src="https://github.com/user-attachments/assets/df2cce9a-50e0-4505-a52e-32df653e1034" />
</p>

어차피 저희가 사용할 건 Zynq패밀리의 7000시리즈니까 설치 용량을 위해 나머지는 죄다 0으로 설정하였습니다. (~~Spartan-7은 이후 프로젝트 때문에 추가로 설치 😭~~) <br/>

<p align="center" style="margin: 20px 0;">
  <img width="85%" alt=".bashrc 사진" src="https://github.com/user-attachments/assets/b2a49a9e-3ff6-43a6-b495-ad90ad2cdaff" />
</p>
...
<p align="center" style="margin: 20px 0;">
  <img width="85%" alt="TP-Link 사이트 사진" src="https://github.com/user-attachments/assets/96b44895-d230-4eef-a4be-ed1fc3e5f877" />
</p>
...
<p align="center" style="margin: 20px 0">
  <img width="85%" alt="visudo 사진" src="https://github.com/user-attachments/assets/59de28bb-c441-43a6-9135-8eb86f7b3caa" /> 
</p>
...
<p align="center" style="margin: 20px 0">
  <img width="85%" alt="ports_wsl.ps1 실행 사진" src="https://github.com/user-attachments/assets/69fb29ef-68b5-4d53-9cf1-80d44f388223" />
</p>
...
<p align="center" style="margin: 20px 0">
  <img width="85%" alt="windows defender 설정 사진" src="https://github.com/user-attachments/assets/d1ea7932-b15a-43d4-8999-a22fd7e5c3d5" />
</p>

이로서 설정은 다 되었고, 내 IP 해당 포트가 열려있는지 확인하기 위해서 해당 사이트를 들어가서 확인해봤습니다.[포트확인 사이트](https://www.yougetsignal.com/tools/open-ports/) <br/>

<p align="center" style="margin: 20px 0">
  <img width="85%" alt="you get signal 페이지 사진" src="https://github.com/user-attachments/assets/431d07f0-fe32-4ef8-bce4-05e5da09fdba" />
</p>

열려있는걸 확인하고 MacOS에서 데스크탑 공인 PC IP의 포트 2222번으로 접속하면? <br/>

<p align="center" style="margin: 20px 0">
  <img width="85%" alt="맥북 서버 접속" src="https://github.com/user-attachments/assets/39409e00-deb7-46f6-aa3e-2d04511dda89" />
</p>
